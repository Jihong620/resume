...
6 年後端 + 3 年前端經驗 | 專精後端開發、系統設計、系統整合維運、IoT 整合開發
...
#### 警勤日報系統開發 (進行中)
- 整合各 Fab(廠區) KPI 指標，將分散於各系統的數據落地至新專案 DB
- 建立前後端架構，提供內部人員使用的 Web UI
- 透過爬蟲整理資料，並以 SMTP Server 寄送 Daily Report
- 實作地端資料同步至雲端，並使用 Grafana/PowerBI 進行數據視覺化與報表呈現
#### <成果>
